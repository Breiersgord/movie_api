http = require('http'), //creates a variable called 'http' then assigns to it an instance of the HTTP module. this is what imports the HTTP module and allows you to use its function createServer()
fs = require('fs'),
url = require('url');
